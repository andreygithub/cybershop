Cybershop.window.Brands = function(config) {
    config = config || {};
    config.id = Ext.id();
    Ext.applyIf(config,{
        url: Cybershop.config.connectorUrl,
        id: config.id,
        baseParams: { action: 'mgr/brands/update' },
        width: 700,
        minWidth:700,
        fields:
        [{
                    ...
                    [{        
                        ...
                        [{
                            ...
                            [{
                                ...
                                xtype: 'numberfield',
                                fieldLabel: _('cs_sort_position') + ' <small>' + _('cs_sort_position_desc') + '</small>',
                                name: 'sort_position',
                                allowNegative: false,
                                allowDecimals: false,
    ...
    Cybershop.window.Brands.superclass.constructor.call(this,config);
...
Ext.extend(Cybershop.window.Brands,MODx.Window,{
    savenew: function() {
...
Ext.reg('cybershop-window-brands',Cybershop.window.Brands);
