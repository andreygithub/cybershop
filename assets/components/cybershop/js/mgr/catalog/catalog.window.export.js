Cybershop.window.catalog_export = function(config) {
    config = config || {};
    config.id = Ext.id();
    Ext.applyIf(config,{
        ...
        ,labelWidth: 180
        ,baseParams: {
            action: 'mgr/catalog/export/update'
        }
        ,fields:
        [{
            xtype: 'hidden'
...
Ext.extend(Cybershop.window.catalog_export,MODx.Window);
Ext.reg('cybershop-window-catalog_export',Cybershop.window.catalog_export);
