...
class csDeliverySortProcessor extends modObjectProcessor {
	public $objectType = 'csDelivery';

	public function process() {
		/* @var csDelivery $source */
		$source = $this->modx->getObject($this->objectType, $this->getProperty('source'));
		/* @var csDelivery $target */
...
return 'csDeliverySortProcessor';