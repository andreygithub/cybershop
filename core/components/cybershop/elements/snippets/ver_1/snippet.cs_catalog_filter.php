...
$cs->modx->regClientStartupScript('/assets/components/imgzoom/js/imgzoom.js');
...
$output_block = '';
$output_block_ajax = '';
if ($params['use_categorys']){$output_block .= $cs->catalog->get_categorys(@$params); }
if ($params['use_brands']){$output_block .= $cs->catalog->get_brands(@$params);}
if ($params['use_filters']){$output_block_ajax .= $cs->catalog->get_filters(@$params);}

$result = $cs->catalog->get_result(@$params);
$params['total'] = $result['total'];

$elementArray['pagination'] = $cs->catalog->get_pagination(@$params);
$elementArray['rows_result'] = $result['rows_result'];
